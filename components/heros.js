    ...
    return (
        <div className="bg-gray-200">
            <div className="max-w-7xl mx-auto py-36 relative">
                <div className="absolute w-full -top-[43px] md:-top-28 left-0 px-5 md:px-0">
                    <div className="flex flex-col md:flex-row md:items-center space-y-10 justify-between">
                        <div className="font-black text-7xl md:text-9xl text-black shadow-xl px-3 py-3">
                            <h1>Our deep</h1>
                            <div className="flex items-center space-x-5">
                                <h1>story.</h1>
                                <p className="text-sm md:text-base max-w-xs font-medium">Still, the second option holds promise could make the tagline shortlist if you are delivering relaxed.</p>
                            </div>
                        </div>
